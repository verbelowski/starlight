...
- Each user on a Discord server where we provide the Service has the right to:
  ...
  * object to the processing of their personal data when it is processed based on the legitimate interests of the Service Provider, particularly if the data is used for statistical analysis or marketing purposes
