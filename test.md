...
- Data wejścia w życie: **15.09.2024**.
...
- **Usługodawca** — oznacza właściciela Usługi, którym jest Vertennn ([kliknij, aby zobaczyć profil](https://discord.com/users/1118126429356445738)).
...
- Usługobiorca bierze na siebie pełną odpowiedzialność za sposób wykorzystywania informacji udostępnionych w ramach Usługi, a także
  ponosi całe ryzyko dotyczące spadku jakości i/lub wydajności, które może wystąpić od czasu do czasu podczas korzystania z Usługi.
...
- Usługodawca zobowiązuje się do rozpatrzenia rekompensaty do jednego dnia od przesłania wiadomości.
...
- Zabrania się podejmowania wobec Usługi działań:
  ...
  * nieprzestrzegających polskiego lub europejskiego prawa.
  * wpływających szkodliwie na jej działanie, a także dla współpracujących z nią podmiotów.

## 7. Wymagania Korzystania z Usługi
- Do działania Usługi w wersji przeglądarkowej niezbędne jest:
  * konto na platformie Discord.
  * stabilne połączenie z Internetem.
  * włączona obsługa plików Cookie i skryptów JavaScript.
- Do działania Usługi w wersji klienckiej niezbędne jest:
  * konto na platformie Discord.
  * stabilne połączenie z Internetem.
  * pobrana aplikacja firmy Discord.
...
- W sprawach nieuregulowanych Regulaminem zastosowanie mają przepisy prawa polskiego, w szczególności Kodeksu Cywilnego, ustawy
  z dnia 30.05.2014 o prawach konsumenta oraz ustawy z dnia 18.07.2002 o świadczeniu usług drogą elektroniczną.
