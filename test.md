...
- **RODO** — Rozporządzenie Parlamentu Europejskiego i Rady (UE) 2016/679 z dnia 27.04.2016 w sprawie ochrony osób fizycznych w
związku z przetwarzaniem danych osobowych oraz w sprawie swobodnego przepływu takich danych, a także uchylenia dyrektywy 95/46/WE.
...
- Niniejsze dane zostają usuwane wraz z zaprzestaniem świadczenia Usługi na danym serwerze Discord, czyli po usunięciu bota z serwera.
...
- Będąc członkiem dowolnego serwera Discord, na którym świadczymy Usługę, przetwarzamy następujące dane:
  * [Kliknij, aby zapoznać się z wykorzystywanymi danymi kont](https://discord.com/developers/docs/resources/user#user-object).
- Dane te umożliwiają wyszukiwanie i wyświetlanie informacji o członkach serwera Discord, a także szybkie wykonywanie poleceń, więc
